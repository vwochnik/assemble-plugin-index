...
module.exports = function(assemble) {
  ...
  */
  function index(index, options, options2) {
    ...
    var postprocessFunc = options.postprocess || function(items, cb) { cb(items); };
    var patternFunc = pattern(options.pattern || (index+':num:'));
    ...
    return through2.obj(function(file, enc, cb) {
      ...
      var paginator = new Paginator(patternFunc);
